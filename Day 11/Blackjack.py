...
def compare(user_score,computer_score):
    ...
    if user_score>21 and computer_score>21:
        return "You Wennt Over, You Loss"
    ...
    #If the computer has a blackjack (0), then the user loses.\
        ...
        return " You Loss, opponent over win"
...
#computer_cards = []
    ...
    user_cards=[]
    computer_cards=[]
    # for 2 cards using for loop
    for _ in range(2):
        # using deal_card function
        user_cards.append(deal_card())
        computer_cards.append(deal_card())


    #Hint 11: The score will need to be rechecked with every new card drawn 
    # and the checks inHint 9 need to be repeated until the game ends.*args
    ...
    while not game_end:
        ...
        if computer_score==0  or computer_score==0 or user_score>21:
            game_end=True
        # then the game ends.
        ...
        # If no, then the game has ended.
            ...
            should_continue=input("You wanna draw another card Type 'y' or 'n':")
